...
public static class LookupTypes
{
    ...
    public static string[] FallbackValues(string type) => type switch
    {
        ...
        TicketCategory => global::IAMS.Api.Entities.TicketCategory.All,
        TicketStatus => global::IAMS.Api.Entities.TicketStatus.All,
        TicketType => TicketTypes.All,
        AssetStatus => global::IAMS.Api.Entities.AssetStatus.All,
        TicketPriority => global::IAMS.Api.Entities.TicketPriority.All,
        _ => []
    };
}
