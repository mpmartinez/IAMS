...
namespace IAMS.Api.Migrations
{
    ...
    [Migration("20260102064019_AddMaintenanceFeature")]
    partial class AddMaintenanceFeature
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IAMS.Api.Entities.Maintenance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("IAMS.Api.Entities.MaintenanceAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("IAMS.Api.Entities.Maintenance", b =>
                {
                    ...
                    b.HasOne("IAMS.Api.Entities.ApplicationUser", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("IAMS.Api.Entities.ApplicationUser", "PerformedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("IAMS.Api.Entities.MaintenanceAttachment", b =>
                {
                    b.HasOne("IAMS.Api.Entities.Maintenance", "Maintenance")
